package com.scholara.student.config;
...
public class DatabaseConfig {
    ...
    public DataSource dataSource() {
        ...
        if (url != null) {
            ...
            url = "jdbc:postgresql://localhost:5432/scholara_students";
        }
    ...
    private DatabaseConnectionInfo parseRenderUrl(String renderUrl) {
        String jdbcUrl = "jdbc:postgresql://localhost:5432/scholara_students";
        ...
        try {
            ...
            jdbcUrl = "jdbc:postgresql://localhost:5432/scholara_students";
        }
